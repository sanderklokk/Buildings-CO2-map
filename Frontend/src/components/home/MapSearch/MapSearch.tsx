  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-row text-sm">
        <div
          className={`w-1/2 text-center h-[45px]  ${searchType == BUILDINGSEARCH ? "bg-trk-deep-blue" : "bg-trk-white active:bg-red-100"}`}
        >
          <button
            className={`${classnames.searchTypeBox} ${searchType == BUILDINGSEARCH ? "text-trk-white" : "text-trk-deep-blue"}`}
        ...
        <div
          className={`w-1/2 text-center h-[45px]  ${searchType == AREASEARCH ? "bg-trk-deep-blue text-trk-white" : "bg-trk-white text-trk-deep-blue"}`}
        >
          <button
            className={`${classnames.searchTypeBox} ${searchType == AREASEARCH ? "text-trk-white" : "text-trk-deep-blue"}`}
